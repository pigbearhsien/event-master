...
export const groupEvents = [
  // 時間還沒確認的 event：投票中
  {
    ...
    voteStart: moment().add(1, "day").toDate(),
    voteEnd: moment().add(2, "day").toDate(),
    voteDeadline: moment().add(2, "hour").toDate(),
    isAccepted: null,
  },
  // 時間還沒確認的 event：投票已結束
  {
  ...
  // 時間已確認但還沒開始的 event：user 還沒確認要不要參加
  {
    ...
    voteStart: moment().subtract(1, "day").toDate(),
    voteEnd: moment().add(1, "day").toDate(),
    voteDeadline: moment().subtract(2, "day").toDate(),
    isAccepted: null,
  },
...
export const availbleHour = [
  {
    start: moment("2023-01-01T00:00:00").toDate(),
    end: moment("2023-01-01T00:30:00").toDate(),
    title: "",
    availbleAmount: 1,
  },
  {
    start: moment("2023-01-01T00:30:00").toDate(),
    end: moment("2023-01-01T01:00:00").toDate(),
    title: "",
    availbleAmount: 2,
  },
  {
    start: moment("2023-01-01T01:00:00").toDate(),
    end: moment("2023-01-01T01:30:00").toDate(),
    title: "",
    availbleAmount: 3,
  },
  {
    start: moment("2023-01-01T01:30:00").toDate(),
    end: moment("2023-01-01T02:00:00").toDate(),
    title: "",
    availbleAmount: 4,
  },
  {
    start: moment("2023-01-01T02:00:00").toDate(),
    end: moment("2023-01-01T02:30:00").toDate(),
    title: "",
    availbleAmount: 5,
  },
  {
    start: moment("2023-01-01T02:30:00").toDate(),
    end: moment("2023-01-01T03:00:00").toDate(),
    title: "",
    availbleAmount: 1,
  },
  {
    start: moment("2023-01-01T03:00:00").toDate(),
    end: moment("2023-01-01T03:30:00").toDate(),
    title: "",
    availbleAmount: 1,
  },
  {
    start: moment("2023-01-01T03:30:00").toDate(),
    end: moment("2023-01-01T04:00:00").toDate(),
    title: "",
    availbleAmount: 1,
  },
  {
    start: moment("2023-01-01T04:00:00").toDate(),
    end: moment("2023-01-01T04:30:00").toDate(),
    title: "",
    availbleAmount: 1,
  },
  {
    start: moment("2023-01-01T04:30:00").toDate(),
    end: moment("2023-01-01T05:00:00").toDate(),
    title: "",
    availbleAmount: 1,
  },
];
