...
@router.get("/listAllVoteAvailableTimeByEventId/{event_id}", response_model=List )
def list_all_vote_available_time_by_event_id(event_id: str, db: Session = Depends(get_db)):
    try:
